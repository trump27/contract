...
<div class="panel panel-default">
    ...
    <?php if (!empty($language->licensehistories)): ?>
        <table class="table table-striped text-nowrap">
            ...
            <tbody>
            <?php foreach ($language->licensehistories as $licensehistories): ?>
                <tr>
...
<div class="panel panel-default">
    ...
    <?php if (!empty($language->licenses)): ?>
        <table class="table table-striped text-nowrap">
            <thead>
            <tr>
                <th><?= __('Id') ?></th>
            ...
            <tbody>
            <?php foreach ($language->licenses as $licenses): ?>
                <tr>
                    <td><?= h($licenses->id) ?></td>
